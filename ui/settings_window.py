"""Settings window for the Image Ranking System."""
...
class SettingsWindow:
    ...
    def create_weight_section(self, parent: tk.Frame):
        ...
        tk.Label(weight_section, text="Left and right images are selected independently.",
    ...
    def create_preference_section(self, parent: tk.Frame):
        """Create the priority preference section."""
        ...
        tk.Label(preference_section, text="Control whether high or low values are prioritized.",
                font=('Arial', 10, 'italic'), fg=Colors.TEXT_SECONDARY, bg=Colors.BG_SECONDARY).pack(pady=5)
        ...
        tk.Button(pref_button_frame, text="Reset Preferences", command=self.reset_preferences_to_defaults,
                 bg=Colors.BUTTON_DANGER, fg='white', relief=tk.FLAT).pack(side=tk.LEFT, padx=5)
    
    def create_side_weight_controls(self, parent: tk.Frame, side: str, title: str):
        """Create weight controls for one side."""
        ...
        weights_info = [
            ...
            ('low_votes', 'Vote Count Weight', 'Weight for vote count priority'),
            ('instability', 'Stability Weight', 'Weight for stability priority'),
    ...
    def create_side_preference_controls(self, parent: tk.Frame, side: str, title: str):
        """Create priority preference controls for one side."""
        tk.Label(parent, text=title, font=('Arial', 12, 'bold'), 
                fg=Colors.TEXT_PRIMARY, bg=Colors.BG_TERTIARY).pack(pady=10)
    ...
    def update_weight_display(self):
        """Update the total weight display and warnings."""
    ...
    def create_tier_distribution_section(self, parent: tk.Frame):
        ...
        description_text = ("Controls how tiers should be distributed. Lower values create tighter distribution.")
