"""
Refactored main window module for the Image Ranking System.

This module implements the primary user interface for image voting,
now split into focused components for better maintainability.
"""
...
class MainWindow:
    ...
    This class now focuses on coordination between components
    rather than handling all functionality directly.
    """
    ...
    def __init__(self, root: tk.Tk):
        ...
        # These will be initialized after UI is built
    ...
    def _setup_application(self) -> None:
        ...
        # Pass ranking algorithm reference to image display for stability calculations
    ...
    def _on_images_loaded(self, images: list) -> None:
        ...
        Args:
            images: List of loaded image filenames
        """
    ...
    def _on_vote_cast(self, winner: str, loser: str) -> None:
        ...
        Args:
            winner: Winning image filename
            loser: Losing image filename
        """
        # Additional processing after vote if needed
        pass
    ...
    def load_data(self) -> None:
        ...
        if filename:
            ...
            # Load data using folder manager
